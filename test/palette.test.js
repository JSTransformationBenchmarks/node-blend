(async function () {
  ...
  var images = [await fs_readFilePromise('test/fixture/1.png'), await fs_readFilePromise('test/fixture/2.png')];
  var palettes = [new blend.Palette(await fs_readFilePromise('test/fixture/palette-1.pal'), 'rgb')];
  describe('palette creation', function () {
    ...
    it('should create a palette from an .act file', async function () {
      var pal = new blend.Palette(await fs_readFilePromise('./test/support/palette64.act'), 'act');
    ...
    it('should create a palette with 256 colors from an .act file', async function () {
      var pal = new blend.Palette(await fs_readFilePromise('./test/support/palette256.act'), 'act');
  ...
  describe('using palettes', function () {
    ...
    it('should handle alpha in palette 2', async function (done) {
      var palette = blend.Palette.fromJSON(['00000000', '008000']);
      blend([await fs_readFilePromise('test/fixture/one_pixel.png')], {
        palette: palette
      }, function (err, data) {
        if (err) return done(err);
